...
namespace cssdk
{
    ...
    */
     ...
     * @brief N/D
    */
    constexpr auto REHLDS_API_VERSION_MINOR = 15;
    ...
    */
    ...
    using ReHookSvCheckUserInfo = IHookChain<int, NetAddress*, char*, qboolean, int, char*>;
    using ReHookRegistrySvCheckUserInfo = IHookChainRegistry<int, NetAddress*, char*, qboolean, int, char*>;

    // PF_precache_generic_I hook
    using ReHookPfPrecacheGenericI = IHookChain<int, const char*>;
    using ReHookRegistryPfPrecacheGenericI = IHookChainRegistry<int, const char*>;

    // PF_precache_model_I hook
    using ReHookPfPrecacheModelI = IHookChain<int, const char*>;
    using ReHookRegistryPfPrecacheModelI = IHookChainRegistry<int, const char*>;

    // PF_precache_sound_I hook
    using ReHookPfPrecacheSoundI = IHookChain<int, const char*>;
    using ReHookRegistryPfPrecacheSoundI = IHookChainRegistry<int, const char*>;

    // EV_Precache hook
    using ReHookEvPrecache = IHookChain<unsigned short, int, const char*>;
    using ReHookRegistryEvPrecache = IHookChainRegistry<unsigned short, int, const char*>;
    ...
    public:
        ...
        virtual ReHookRegistrySvCheckUserInfo* SvCheckUserInfo() = 0;
        virtual ReHookRegistryPfPrecacheGenericI* PfPrecacheGenericI() = 0;
        virtual ReHookRegistryPfPrecacheModelI* PfPrecacheModelI() = 0;
        virtual ReHookRegistryPfPrecacheSoundI* PfPrecacheSoundI() = 0;
        virtual ReHookRegistryEvPrecache* EvPrecache() = 0;
    };
