...
namespace cssdk
{
    ...
    */
     ...
     * @brief N/D
    */
    constexpr auto REGAMEDLL_API_VERSION_MINOR = 30;
    ...
    */
    ...
    using ReHookPmAirAccelerate = IHookChain<void, float*, float, float>;
    using ReHookRegistryPmAirAccelerate = IHookChainRegistry<void, float*, float, float>;
    ...
    // CSGameRules::PlayerGotWeapon hook
    ...
    using ReHookBotManagerOnEvent = IHookChain<void, int, EntityBase*, EntityBase*>;
    using ReHookRegistryBotManagerOnEvent = IHookChainRegistry<void, int, EntityBase*, EntityBase*>;
    ...
    using ReHookPlayerWeaponKickBack =
        IHookChainClass<void, PlayerWeaponBase, float, float, float, float, float, float, int>;
    using ReHookRegistryPlayerWeaponKickBack =
        IHookChainClassRegistry<void, PlayerWeaponBase, float, float, float, float, float, float, int>;
    ...
    // CSGameRules::SendDeathMessage hook
    using ReHookGameRulesSendDeathMessage =
        IHookChain<void, EntityBase*, PlayerBase*, PlayerBase*, EntityVars*, const char*, int, int>;
    using ReHookRegistryGameRulesSendDeathMessage =
        IHookChainRegistry<void, EntityBase*, PlayerBase*, PlayerBase*, EntityVars*, const char*, int, int>;
    ...
    using ReHookPlayerRemoveAllItems = IHookChainClass<void, PlayerBase, qboolean>;
    using ReHookRegistryPlayerRemoveAllItems = IHookChainClassRegistry<void, PlayerBase, qboolean>;

    // CBasePlayer::UpdateStatusBar hook
    using ReHookPlayerUpdateStatusBar = IHookChainClass<void, PlayerBase>;
    using ReHookRegistryPlayerUpdateStatusBar = IHookChainClassRegistry<void, PlayerBase>;

    // CBasePlayer::TakeDamageImpulse hook
    using ReHookPlayerTakeDamageImpulse = IHookChainClass<void, PlayerBase, PlayerBase*, float, float>;
    using ReHookRegistryPlayerTakeDamageImpulse = IHookChainClassRegistry<void, PlayerBase, PlayerBase*, float, float>;

    // SendSayMessage hook
    using ReHookSendSayMessage =
        IHookChain<void, PlayerBase*, const char*, qboolean, const char*, const char*, const char*, bool, const char*, bool>;
    using ReHookRegistrySendSayMessage =
        IHookChainRegistry<void, PlayerBase*, const char*, qboolean, const char*, const char*, const char*, bool, const char*, bool>;
    ...
    public:
        ...
        virtual ReHookRegistryPlayerRemoveAllItems* PlayerRemoveAllItems() = 0;
        virtual ReHookRegistryPlayerUpdateStatusBar* PlayerUpdateStatusBar() = 0;
        virtual ReHookRegistryPlayerTakeDamageImpulse* PlayerTakeDamageImpulse() = 0;
        virtual ReHookRegistrySendSayMessage* SendSayMessage() = 0;
    };
